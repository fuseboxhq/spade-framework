...
Check for an existing open Lead first through {{SPADE_SHELL}}:
...
If either is absent, attempt to create it through {{SPADE_SHELL}}.
...
Create the issue through {{SPADE_SHELL}}:
...
Run the requested on-demand subcommand through {{SPADE_SHELL}}:
