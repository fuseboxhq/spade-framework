...
exec_command before the first experiment mutation.
...
request_user_input when available, otherwise a concise direct question with exactly:
...
At the same point, through exec_command, write `unhinged` to
