...
Present the agent recommendation and its evidence, then ask the human through `request_user_input when available, otherwise a concise direct question` to select exactly one existing verdict:
