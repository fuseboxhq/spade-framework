...
Draft first.
When the brief carries the intent, draft the whole Scope, show it, and ask one question through `request_user_input when available, otherwise a concise direct question`: *Lock this Scope* or *Edit it*.
