...
Check for an existing open Lead first through Bash:
...
If either is absent, attempt to create it through Bash.
...
Run the requested on-demand subcommand through Bash:
