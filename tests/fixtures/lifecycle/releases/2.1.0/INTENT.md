...
The core loop is stable; the framework is at v2.1.0 with host-neutral
canonical authoring and full Claude/Codex projections, and it continues to
evolve through reviewed Scopes without weakening human-owned gates.
