...
The core loop is stable; the framework is at v4.0.0 with classified, capture-first Leads, governed non-shipping experiments, pre-Scope frontier discovery, host-neutral canonical authoring, full Claude/Codex projections, strict card-based Plans, resumable verified runs, human-gated learning candidates, two-axis delivery review, and acceptance evidence that preserves human-owned Evaluate and Ship gates.
