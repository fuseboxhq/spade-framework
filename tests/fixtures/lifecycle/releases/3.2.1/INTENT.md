...
The core loop is stable; the framework is at v3.2.1 with governed pre-Scope frontier discovery, host-neutral canonical authoring, full Claude/Codex projections, tracer-bullet Plans, resumable verified runs, human-gated learning candidates, two-axis delivery review, and acceptance evidence that preserves human-owned Evaluate and Ship gates.
