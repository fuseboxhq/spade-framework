...
| Skill | What it does |
|-------|-------------|
| `/spade` | Orchestrator entry point: pick an autonomy level (Deliver/Plan/Scope/Stub); bootstraps fresh Scope/Stub work or continues from a locked Scope; halts on a tripwire; Deliver not yet available (PS-1862); routes trivial work to `/spade-quick` |
...
| `/spade-review` | Dynamic-cast multi-persona second opinion (canonical five + ad-hoc personas, merged findings) on a Scope, Plan, or both |
